...
pkgdatadir = $(datadir)/aspire
pkgincludedir = $(includedir)/aspire
pkglibdir = $(libdir)/aspire
pkglibexecdir = $(libexecdir)/aspire
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/aspire-config.h.in \
...
CONFIG_HEADER = $(top_builddir)/src/config/aspire-config.h
...
ACLOCAL = ${SHELL} /home/coinbitex/Zeurocoin/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/coinbitex/Zeurocoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/coinbitex/Zeurocoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/coinbitex/Zeurocoin/build-aux/missing automake-1.14
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/coinbitex/Zeurocoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = aspire
PACKAGE_BUGREPORT = info@aspirecoin.io
PACKAGE_NAME = Aspire Core
PACKAGE_STRING = Aspire Core 1.3.0
PACKAGE_TARNAME = aspire
PACKAGE_URL = 
...
abs_builddir = /home/coinbitex/Zeurocoin
abs_srcdir = /home/coinbitex/Zeurocoin
abs_top_builddir = /home/coinbitex/Zeurocoin
abs_top_srcdir = /home/coinbitex/Zeurocoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/coinbitex/Zeurocoin/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/aspired$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/aspire-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/aspire-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Aspire-Qt.app
OSX_DMG = Aspire-Qt.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_aspire_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_aspire_coverage.info test_aspire.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Aspire-Qt
...
src/config/aspire-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/aspire-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/aspire-config.h
$(top_srcdir)/src/config/aspire-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/aspire-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Aspire-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Aspire-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Aspire-Qt" -no-pad -r -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Aspire-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_aspire.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_aspire -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_aspire_filtered.info: test_aspire.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_aspire_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_aspire_coverage.info: baseline_filtered_combined.info test_aspire_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_aspire_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_aspire_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_aspire_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_aspire.coverage/.dirstamp:  test_aspire_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_aspire.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_aspire.coverage/ total.coverage/ $(OSX_APP)
