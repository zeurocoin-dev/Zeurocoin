...
RESOURCES += src/qt/zeuro.qrc src/qt/zeuro_locale.qrc
TRANSLATIONS += src/qt/locale/zeuro_bg.ts \
                src/qt/locale/zeuro_de.ts \
                src/qt/locale/zeuro_en.ts \
                src/qt/locale/zeuro_es.ts \
                src/qt/locale/zeuro_fi.ts \
                src/qt/locale/zeuro_fr.ts \
                src/qt/locale/zeuro_it.ts \
                src/qt/locale/zeuro_ja.ts \
                src/qt/locale/zeuro_pl.ts \
                src/qt/locale/zeuro_pt.ts \
                src/qt/locale/zeuro_ru.ts \
                src/qt/locale/zeuro_sk.ts \
                src/qt/locale/zeuro_sv.ts \
                src/qt/locale/zeuro_vi.ts \
                src/qt/locale/zeuro_zh_CN.ts \
                src/qt/locale/zeuro_zh_TW.ts
