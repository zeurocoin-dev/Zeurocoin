...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Aspire Core zeuro-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zeuro-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zeuro transaction") + "\n" +
              "  zeuro-tx [options] -create [commands]   " + _("Create hex-encoded zeuro transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zeuro transaction
