/* src/config/aspire-config.h.  Generated from aspire-config.h.in by configure.  */
/* src/config/aspire-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ASPIRE_CONFIG_H

#define ASPIRE_CONFIG_H
