    ...
    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Nitrosend Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::NitrosendMakeCollaterals));
    typeWidget->addItem(tr("Nitrosend Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::NitrosendCreateDenominations));
    typeWidget->addItem(tr("Nitrosend Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::NitrosendDenominate));
    typeWidget->addItem(tr("Nitrosend Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::NitrosendCollateralPayment));
