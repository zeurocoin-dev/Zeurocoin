    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Zeuro Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Zeuro Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  zeuro-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Zeuro Core is shutting down...") + "<br /><br />" +
