...
Only requiring some minor changes is zeuro.cpp.
...
Changes to zeuro.cpp
----------------------
zeuro.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
